...
const Agent = ({ userName, userId, type }: AgentProps) => {
    ...
    const[callStatus, setCallStatus] = React.useState<CallStatus>(CallStatus.INACTIVESTATE);
    ...
    useEffect(() => {
        ...
        const onCallError = (error: Error) => console.error('Call error:', error);
    ...
    const handleCall = async () => {
        ...
        try {
            ...
            console.log(process.env.NEXT_PUBLIC_VAPI_WORKFLOW_ID, "Workdflow ID");
    ...
    const isCallInactiveOrFinished = callStatus === CallStatus.INACTIVESTATE || callStatus === CallStatus.FINISHED;
